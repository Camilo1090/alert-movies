...
describe('PersonMovies component test', () => {
      ...
      providers: [
        { provide: APP_BASE_HREF, useValue: '/' },
        {
          provide: PeopleService, useClass: class {
            getPersonMovies = getPersonMoviesSpy;
          }
        },
        {
  ...
  describe('WHEN ngOnInit function is called', () => {
    beforeEach(() => {
      ...
      spyOn(component, 'updatePersonMovies').calls.reset();
  ...
  describe('WHEN updatePersonMovies function is called', () => {
    let id: number;
    beforeEach(() => {
      getPersonMoviesSpy.calls.reset();
    ...
    it('SHOULD call service', () => {
      ...
      expect(component.peopleService.getPersonMovies)
        .toHaveBeenCalledTimes(1);
      expect(component.peopleService.getPersonMovies)
    ...
    it('SHOULD handle error', () => {
      getPersonMoviesSpy.and.returnValue(Observable.throw('test error'));
      component.updatePersonMovies();
