...
describe('SeriesCast component test', () => {
  ...
  describe('WHEN ngOnInit function is called', () => {
    beforeEach(() => {
      ...
      spyOn(component, 'updateSeriesCast').calls.reset();
    ...
    it('SHOULD call functions', fakeAsync(() => {
      ...
      expect(component.updateSeriesCast)
        .toHaveBeenCalledTimes(1);
  ...
  describe('WHEN updateSeriesCast function is called', () => {
    ...
    it('SHOULD set values', () => {
      ...
      expect(component.seriesCast)
        .toEqual((<any>seriesDetails).cast.slice(0, 20));
    });
  ...
  describe('WHEN registerLoading function is called', () => {
    ...
    it('SHOULD call functions', () => {
      expect(component._loadingService.register)
        .toHaveBeenCalledTimes(1);
      expect(component._loadingService.register)
        .toHaveBeenCalledWith('series-cast');
    });
  });
